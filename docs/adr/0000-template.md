...
What forces a decision here. The constraints that are not negotiable, and the ones that only look that way. Facts about tools or the environment carry the command that establishes them.
...
The conditions under which this decision would become wrong. If none can be named, the decision was not a real arbitration.
